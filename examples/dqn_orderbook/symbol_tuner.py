...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        if tune:
            ...
            self._kwargs['max_flat_position_length'] = self.trial.suggest_int('max_flat_position_length', 1, 1000)
        ...
        params = dict()
        params['cache_limit'] = 2442
        params['delta_clip'] = 68.84252281979566
        params['dueling_type'] = 'avg'
        params['enable_double_dqn'] = False
        params['gamma'] = 0.6854837169236557
        params['memory_interval'] = 54
        params['beta_1'] = 0.21619427631881105
        params['beta_2'] = 0.5149478757396816

        params['lstm_size'] = 56
        params['num_lstm'] = 3
        params['kernel_size'] = 3
        params['block_kernel'] = 6
        params['num_dense'] = 3
        params['dense_width'] = 4
        params['num_conv'] = 2
        params['base_filter_size'] = 87
        params['strides'] = 10
        params['action_repetition'] = 1
        params['eps_greedy_policy_steps'] = 723773
        params['lr'] = 0.0009579249814787723
        params['batch_size'] = 51
        params['max_flat_position_length'] = 369
        params['max_short_position_length'] = 195
        ...
        params['target_model_update'] = 179
        params['train_interval'] = 1240
