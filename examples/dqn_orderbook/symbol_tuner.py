...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        params['delta_clip'] = 16.09334973978158
        params['dense_width'] = 149
        params['dueling_type'] = 'naive'
        params['enable_double_dqn'] = False
        params['eps_greedy_policy_steps'] = 24683
        params['gamma'] = 0.26914123941935675
        params['kernel_size'] = 3
        params['lr'] = 0.00473137334910344
        params['lstm_size'] = 78
