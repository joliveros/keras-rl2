...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        params = dict()
        params['cache_limit'] = 1588
        params['delta_clip'] = 48.471176448637785
        params['dueling_type'] = 'max'
        params['enable_double_dqn'] = False
        params['gamma'] = 0.5260141422379877
        params['memory_interval'] = 87
        params['beta_1'] = 0.20704413322842097
        params['beta_2'] = 0.6279876638685917
        ...
        params['num_dense'] = 1
        params['dense_width'] = 18
        params['num_conv'] = 3
        params['base_filter_size'] = 76
        params['strides'] = 7
        params['action_repetition'] = 1
        params['eps_greedy_policy_steps'] = 273495
        params['lr'] = 0.0006259458667049414
        params['batch_size'] = 18
        params['max_flat_position_length'] = 965
        params['max_short_position_length'] = 255
        ...
        params['target_model_update'] = 43
        params['train_interval'] = 1568
