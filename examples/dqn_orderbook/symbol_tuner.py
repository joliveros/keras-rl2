...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        params['delta_clip'] = 61.77126081604265
        params['dense_width'] = 22
        params['dueling_type'] = 'naive'
        params['enable_double_dqn'] = False
        params['eps_greedy_policy_steps'] = 3165
        params['gamma'] = 0.429846862445845
        params['kernel_size'] = 3
        params['lr'] = 0.0001807834874778474
        params['lstm_size'] = 103
