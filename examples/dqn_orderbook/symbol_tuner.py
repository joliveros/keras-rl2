...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        params['delta_clip'] = 50.801197952017496
        params['dense_width'] = 30
        params['dueling_type'] = 'max'
        params['enable_double_dqn'] = False
        params['eps_greedy_policy_steps'] = 174677
        params['gamma'] = 0.8253556638208488
        params['kernel_size'] = 1
        params['lr'] = 0.005322354103736138
        params['lstm_size'] = 68
        params['max_change'] = 0.01
        params['max_flat_position_length'] = 144
        params['max_position_length'] = 31
        params['max_short_position_length'] = 59
        params['memory_interval'] = 133
        ...
        params['strides'] = 15
        params['target_model_update'] = 11
        params['trading_fee'] = 0.0004 * 4
        params['train_interval'] = 120
