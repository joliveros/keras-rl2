...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        params['delta_clip'] = 86.42263976573571
        params['dense_width'] = 365
        params['dueling_type'] = 'naive'
        params['enable_double_dqn'] = False
        params['eps_greedy_policy_steps'] = 1338
        params['gamma'] = 0.8770547779898744
        params['kernel_size'] = 1
        params['lr'] = 0.0008807300535470611
        params['lstm_size'] = 67
        params['max_change'] = 0.01
        params['max_flat_position_length'] = 199
        params['max_position_length'] = 31
        params['max_short_position_length'] = 66
        params['memory_interval'] = 187
        ...
        params['strides'] = 4
        params['target_model_update'] = 6
        params['trading_fee'] = 0.0012
        params['train_interval'] = 11
