...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        params['base_filter_size'] = 16
        params['batch_size'] = 18
        params['beta_1'] = 0.8461788232873183
        params['beta_2'] = 0.48689240541346773
        params['block_kernel'] = 2
        params['cache_limit'] = 3769
        params['delta_clip'] = 85.89477631613583
        params['dense_width'] = 178
        params['dueling_type'] = 'avg'
        params['enable_double_dqn'] = False
        params['eps_greedy_policy_steps'] = 163310
        params['gamma'] = 0.8302894675267979
        params['kernel_size'] = 4
        params['lr'] = 0.0054098628126301885
        params['lstm_size'] = 183
        params['max_change'] = 0.01
        params['max_flat_position_length'] = 57
        params['max_position_length'] = 31
        params['max_short_position_length'] = 142
        params['memory_interval'] = 398
        ...
        params['strides'] = 11
        params['target_model_update'] = 508
        params['trading_fee'] = 0.0004 * 4
        params['train_interval'] = 33
        params['reward_ratio'] = 423.8531305511032
