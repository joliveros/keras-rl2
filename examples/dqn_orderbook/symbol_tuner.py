...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        params['delta_clip'] = 49.29190173839783
        params['dense_width'] = 390
        params['dueling_type'] = 'naive'
        params['enable_double_dqn'] = False
        params['eps_greedy_policy_steps'] = 1851
        params['gamma'] = 0.2989121732335155
        params['kernel_size'] = 1
        params['lr'] = 0.00018856434009514124
        params['lstm_size'] = 58
        params['max_change'] = 0.01
        params['max_flat_position_length'] = 26
        params['max_position_length'] = 31
        params['max_short_position_length'] = 78
        params['memory_interval'] = 182
