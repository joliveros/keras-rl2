...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        params = dict()
        params['cache_limit'] = 8200
        params['delta_clip'] = 29.150723889782284
        params['dueling_type'] = 'naive'
        params['enable_double_dqn'] = False
        params['gamma'] = 0.6458993652987611
        params['memory_interval'] = 34
        params['beta_1'] = 0.6420330431221527
        params['beta_2'] = 0.9075664131890278
        ...
        params['num_dense'] = 2
        params['dense_width'] = 111
        params['num_conv'] = 11
        params['base_filter_size'] = 72
        params['strides'] = 14
        params['action_repetition'] = 1
        params['eps_greedy_policy_steps'] = 813098
        params['lr'] = 0.00497390723300335
        params['batch_size'] = 42
        params['max_flat_position_length'] = 398
        params['max_short_position_length'] = 111
        ...
        params['target_model_update'] = 15
        params['train_interval'] = 3116
