...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        if tune:
            ...
            self._kwargs['max_flat_position_length'] = self.trial.suggest_int('max_flat_position_length', 1, 400)
        ...
        params = dict()
        params['cache_limit'] = 2264
        params['delta_clip'] = 48.92792219294178 
        params['dueling_type'] = 'avg'
        params['enable_double_dqn'] = False
        params['gamma'] = 0.7061482158038529
        params['memory_interval'] = 70
        params['beta_1'] = 0.17871667103956151
        params['beta_2'] = 0.5517287697796514

        params['lstm_size'] = 51
        params['num_lstm'] = 3
        params['kernel_size'] = 3
        params['block_kernel'] = 5
        params['num_dense'] = 1
        params['dense_width'] = 14
        params['num_conv'] = 2
        params['base_filter_size'] = 81
        params['strides'] = 9
        params['action_repetition'] = 1
        params['eps_greedy_policy_steps'] = 285709
        params['lr'] = 0.00029984476453753545
        params['batch_size'] = 24
        params['max_flat_position_length'] = 382
        params['max_short_position_length'] = 192
        ...
        params['target_model_update'] = 197
        params['train_interval'] = 657
