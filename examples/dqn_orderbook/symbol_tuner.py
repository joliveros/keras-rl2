...
class SymbolTuner(StudyWrapper):
    ...
    def agent(self):
        ...
        params['base_filter_size'] = 27
        params['batch_size'] = 18
        params['beta_1'] = 0.5802412354434223
        params['beta_2'] = 0.3114630037141044
        params['block_kernel'] = 4
        params['cache_limit'] = 4588
        params['delta_clip'] = 37.41800541129433
        params['dense_width'] = 38
        params['dueling_type'] = 'max'
        params['enable_double_dqn'] = False
        params['eps_greedy_policy_steps'] = 234997
        params['gamma'] = 0.81105326235068
        params['kernel_size'] = 2
        params['lr'] = 0.0059311321142516945
        params['lstm_size'] = 175
        params['max_change'] = 0.01
        params['max_flat_position_length'] = 104
        params['max_position_length'] = 31
        params['max_short_position_length'] = 66
        params['memory_interval'] = 142
        ...
        params['strides'] = 5
        params['target_model_update'] = 128
        params['trading_fee'] = 0.0004 * 4
        params['train_interval'] = 24
        params['reward_ratio'] = 15.905324090399581
